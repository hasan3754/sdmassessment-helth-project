...
<tr>
  <td><input type="radio" name="Standing" id="allot" checked="checked" value="Good"></td>
...
<table >
  ...
  <tr>
    <td><input type="radio" name="Pelvic_Tilt" id="allot" checked="checked" value="Ant"></td>
  ...
  <table >
    ...
    <tr>
      <td><input type="radio" name="Sitting" id="allot" checked="checked" value="Slough"></td>
  ...
  <div id="Transition1" style="display: none">
    <table>
      ...
      <tr>
        <td><input type="radio" name="Transition" id="allot" checked="checked" value="Goodd"></td>
    ...
    <div id="Bed_Mobility1" style="display: none">
      <table>
        ...
        <tr>
          <td><input type="radio" name="Bed_Mobility" id="allot" checked="checked" value="Painful"></td>
...
<span>What problem do you have?</span>
...
<div id="dvPassport" style="display: none">
  <input type="radio" name="bedStatus" id="allot" checked="checked" value="right">Right
...
<div id="divPassport" style="display: none">
  ...
  <tr>
    <td><input type="radio" name="redStatus" id="allot" checked="checked" value="Pain"></td>
...
<div id="divePassport" style="display: none">
  ...
  <tr>
    <td><input type="radio" name="gedStatus" id="allot" checked="checked" value="mild"></td>
